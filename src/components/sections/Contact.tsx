...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-background relative">
      <div className="absolute top-1/3 left-10 w-[20rem] h-[20rem] bg-accent-green/5 rounded-full blur-[90px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 bg-card-bg border border-border-github rounded-xl space-y-6">
              <h3 className="text-lg font-bold text-white font-mono border-b border-border-github pb-3">
                Contact Information
              </h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-sm text-text-muted font-mono">
                  <div className="w-9 h-9 rounded-lg bg-background border border-border-github flex items-center justify-center text-accent-blue">
                    <Mail className="w-4 h-4" />
                  </div>
                  <div>
                    <p className="text-[10px] text-text-muted uppercase">Email Address</p>
                    <a href="mailto:rodricks@example.com" className="text-white hover:text-accent-blue transition-colors">
                ...
                <div className="flex items-center gap-3 text-sm text-text-muted font-mono">
                  <div className="w-9 h-9 rounded-lg bg-background border border-border-github flex items-center justify-center text-accent-green">
              ...
              <div className="pt-4 border-t border-border-github/70 space-y-3">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-background border border-border-github hover:border-accent-blue/50 hover:text-white text-xs font-mono text-text-muted rounded-md transition-all w-full justify-center"
                  >
          ...
          <div className="lg:col-span-7">
            <div className="bg-card-bg border border-border-github rounded-xl p-6">
              ...
              <div className="border-b border-border-github pb-4 mb-6">
                <h3 className="text-lg font-bold text-white font-mono">Send a Message</h3>
              ...
              {isSubmitted && (
                <div className="mb-6 p-4 bg-accent-green/10 border border-accent-green/30 text-white rounded-lg flex items-center gap-2.5 font-mono text-sm animate-fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-background border border-border-github focus:border-accent-blue focus:ring-1 focus:ring-accent-blue text-sm text-white px-3.5 py-2.5 rounded-md outline-none transition-all font-sans"
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-background border border-border-github focus:border-accent-blue focus:ring-1 focus:ring-accent-blue text-sm text-white px-3.5 py-2.5 rounded-md outline-none transition-all font-sans resize-none"
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 py-3 text-sm font-semibold text-white bg-accent-green hover:bg-accent-green-hover disabled:opacity-50 border border-border-github rounded-md transition-all shadow-sm shadow-accent-green/10 font-mono"
                  >
                    {isSubmitting ? (
                      <>
